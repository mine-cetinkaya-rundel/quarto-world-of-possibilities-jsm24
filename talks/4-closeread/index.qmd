...
```{=html}
<iframe class="slide-deck" src="https://tinyurl.com/abray-closeread" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
## Speaker

![](andrew.jpg){style="float: right; padding-left: 10px;" fig-alt="Photo of Andrew Bray" width="300"}
